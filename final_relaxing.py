#!/usr/bin/env python3
"""Relaxing Music Video - 10 minutos"""
...
def create_relaxing_video():
    ...
    cmd = [
        ...
        'drawtext=fontfile=/Windows/Fonts/arial.ttf:text=\'Peaceful Atmospheric Sounds\':fontsize=36:fontcolor=lightgray:x=(w-text_w)/2:y=h/2,'
        'drawtext=fontfile=/Windows/Fonts/arial.ttf:text=\'Relax \\\\u2776 Breathe \\\\u2777 Peace\':fontsize=42:fontcolor=silver:x=(w-text_w)/2:y=2h/3',
